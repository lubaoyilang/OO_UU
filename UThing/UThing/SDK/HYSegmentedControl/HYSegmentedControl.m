...
- (id)initWithOriginY:(CGFloat)y Titles:(NSArray *)titles delegate:(id)delegate
{
    ...
    if (self = [super initWithFrame:rect4View]) {
        ...
        for (int i = 0; i<[titles count]; i++) {
            ...
            [btn setTitleColor:RGBCOLOR(248, 151, 0) forState:UIControlStateSelected];
            [btn setTitle:[titles objectAtIndex:i] forState:UIControlStateNormal];
            [btn addTarget:self action:@selector(_segmentedControlChange:) forControlEvents:UIControlEventTouchUpInside];
        ...
        //  bottom lineView
        //
        _bottomLineView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, HYSegmentedControl_Height-2, width4btn, 2.0f)];
        _bottomLineView.backgroundColor = RGBCOLOR(247, 142, 0);
...
- (void)_segmentedControlChange:(UIButton *)btn
{
