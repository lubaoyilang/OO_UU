...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier cellHeight:(float)cellh
{
    ...
    if (self) {
        ...
        _orderNumLabel.text = [NSString stringWithFormat:@"订单号: %@",@""];
        ...
        _brandTime = [[UILabel alloc] initWithFrame:CGRectMake(10, 65, kMainScreenWidth-20, 20)];
        
        _brandTime.backgroundColor = [UIColor clearColor];
        _brandTime.font = [UIFont systemFontOfSize:12];
        _brandTime.textColor = RGBCOLOR(136, 136, 136);
        _brandTime.text = [NSString stringWithFormat:@"出行时间: %@",@""];
        [_bg addSubview:_brandTime];
        
        
        
        _brandPopCount = [[UILabel alloc] initWithFrame:CGRectMake(10, 90, kMainScreenWidth-20, 20)];
        
        _brandPopCount.backgroundColor = [UIColor clearColor];
        _brandPopCount.font = [UIFont systemFontOfSize:12];
        _brandPopCount.textColor = RGBCOLOR(136, 136, 136);
        _brandPopCount.text = [NSString stringWithFormat:@"出行人数: %@",@""];
        [_bg addSubview:_brandPopCount];
        
        
        
        
        _brandMoneyTitle = [[UILabel alloc] initWithFrame:CGRectMake(10, 115, 60, 20)];
        ...
        _brandMoneyDetail = [[UILabel alloc] initWithFrame:CGRectMake(70, 115, kMainScreenWidth-20-70, 20)];
        ...
        _payBtn.frame = CGRectMake(10, 140, BtnWidth, BtnHeight);
        ...
        _detailBtn.frame = CGRectMake(10+wOff+BtnWidth, 140, BtnWidth, BtnHeight);
...
- (void)refreshViewWithObject:(NSDictionary*)dict
{
    ...
    switch (status) {
        ...
        case 2:
        {
            ...
            _payBtn.hidden = YES;
            _detailBtn.hidden = NO;
            _detailBtn.frame =CGRectMake(x, 140, BtnWidth, BtnHeight);
